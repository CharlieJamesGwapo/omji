      ...
      <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
        {quickActions.map((action) => (
          <button
            ...
            className="relative bg-white rounded-lg border border-gray-200 p-3 text-center hover:border-gray-300 hover:bg-gray-50 transition-colors"
          >
            {action.badge ? (
          ...
          <div className="divide-y divide-gray-50">
            {recentUsers.length === 0 ? (
              ...
              recentUsers.map((user) => (
                <div key={user.id} className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50">
          ...
          <div className="divide-y divide-gray-50">
            {recentDrivers.length === 0 ? (
              ...
              recentDrivers.map((driver) => (
                <div key={driver.id} className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50">
                  <div className="w-7 h-7 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 text-xs font-semibold flex-shrink-0">
