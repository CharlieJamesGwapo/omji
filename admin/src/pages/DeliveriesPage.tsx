          ...
          >
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-100">
              ...
              <select
                ...
                className="text-sm min-h-[44px] px-2 py-1.5 border border-gray-200 rounded-lg bg-white focus:ring-2 focus:ring-red-600 focus:border-red-600 outline-none disabled:opacity-50"
              >
