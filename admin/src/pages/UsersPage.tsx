    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">{stats.total} total users</p>
        </div>
        <input
          type="text"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
          ...
          <div className="text-green-100 text-sm mt-1">Verified</div>
        </div>
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
          <div className="text-3xl font-bold">{stats.admins}</div>
          <div className="text-purple-100 text-sm mt-1">Admins</div>
        </div>
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white shadow-lg">
          <div className="text-3xl font-bold">{stats.drivers}</div>
          <div className="text-orange-100 text-sm mt-1">Drivers</div>
        </div>
        <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-xl p-6 text-white shadow-lg">
          <div className="text-3xl font-bold">{stats.regular}</div>
          <div className="text-red-100 text-sm mt-1">Regular Users</div>
        </div>
      </div>
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-t-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-red-600 text-2xl font-bold">
                    {selectedUser.name?.charAt(0).toUpperCase() || 'U'}
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold text-white">{selectedUser.name}</h2>
                    <p className="text-red-100 text-sm">User ID: #{selectedUser.id}</p>
                  </div>
                </div>
                <button
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="text-sm font-medium text-gray-900">{selectedUser.email || 'Not provided'}</div>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
