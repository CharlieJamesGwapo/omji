  ...
  const generateEarningsReport = async () => {
    try {
      ...
      const html = `
        ...
        <body>
          <div class="header">
            <h1>ONE RIDE Earnings Report</h1>
          ...
          <div class="footer">
            <p>ONE RIDE - Balingasag & Salay Transport & Delivery Platform</p>
            <p>This report was automatically generated by ONE RIDE App</p>
          </div>
        </body>
        </html>
      `;
      ...
      await Sharing.shareAsync(uri, { mimeType: 'application/pdf', dialogTitle: 'ONE RIDE Earnings Report' });
    } catch (error) {
